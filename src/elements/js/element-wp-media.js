		...
		this.each(function(){
			...
			$mediaButton.on('click', function(event){
				...
				file_frame.on('open', function(){
					...
					$this.find('input.gp-wpmedia-value').each(function(i, obj){
			...
			$this.on('click', 'button.attachment-close', function(){
				$(this).closest('div.gp-wpmedia-item').fadeOut('fast', function(){
					$(this).remove();
				});
			});
		});
