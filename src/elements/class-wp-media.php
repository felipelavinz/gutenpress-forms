...
class WP_Media extends Forms\Form_Component{
	...
	public function get_default_args(){
		return [
			...
			'multiple'    => false,
			'button'      => array(
				'text' => _x('Select file', 'WP_Media button text', 'gutenpress'),
			)
		];
	}

	public function get_upload_button_text(){
		return _x('Upload or select an existing file', 'WP_Media button text', 'gutenpress');
	}

	public function get_remove_button_text(){
		return _x('Remove file', 'WP_Media button text', 'gutenpress');
	}

	public function get_replace_button_text(){
		return _x('Replace file', 'WP_Media button text', 'gutenpress');
	}
